...
- Role-based Jobseeker & Recruiter dashboards  
- AI Resume Matching with eligibility score (75% threshold)  
- Automated AI interview workflow with email notifications  
